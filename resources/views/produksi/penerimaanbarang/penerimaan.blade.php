                        ...
                        <fieldset>
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nota" id="nota" placeholder="Masukkan nomor nota order produksi" autofocus>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="qty" class="col-sm-2 col-form-label">QTY Terima</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="qty" id="qty" placeholder="Masukkan qty">
                                    </div>
                                </div>
                            </form>
                        </fieldset>
