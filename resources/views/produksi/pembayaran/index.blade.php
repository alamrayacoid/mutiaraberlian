            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <ul class="nav nav-pills mb-3" id="Tabzs">
                        <li class="nav-item">
                            <a href="#pembayaran" class="nav-link active" data-target="#pembayaran" aria-controls="pembayaran" data-toggle="tab" role="tab">Pembayaran</a>
                        </li>
                        <li class="nav-item">
                            <a href="#history" class="nav-link" data-target="#history" aria-controls="history" data-toggle="tab" role="tab">History Pembayaran</a>
                        </li>
                    </ul>
