                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-12 mb-3">
                            <input type="hidden" name="idRPO" id="idRPO_edit">
                        ...
                        <div class="col-md-10 col-sm-12 mb-3">
                            <input type="text" name="txt_nota_edit" id="txt_nota_edit" class="form-control-plaintext form-control-sm" readonly/>
                        </div>
                        <div class="col-md-2 col-sm-12 mt-2">
                            <label>Metode</label>
                        </div>
                        <div class="col-md-10 col-sm-12 mb-3">
                            <input type="text" name="txt_metode_edit" id="txt_metode_edit" class="form-control-plaintext form-control-sm" readonly/>
                        </div>
                        <div class="col-md-2 col-sm-12 mt-2">
                        ...
                        <div class="col-md-10">
                            <textarea name="note_return_edit" id="note_return_edit" rows="10" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
