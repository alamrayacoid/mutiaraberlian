...
<article class="content animated fadeInLeft">
	...
	<div class="title-block text-primary">
	    <h1 class="title"> Edi Data User </h1>
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
	    	 / <span>Pengaturan</span>
	    	 / <a href="{{route('pengaturanpengguna.index')}}">Pengaturan Pengguna</a>
	    	 / <span class="text-primary font-weight-bold">Edit Data User</span>
	     </p>
	</div>
				...
				<div class="card">
                    <div class="card-header bordered p-2">
                    	<div class="header-block">
                            <h3 class="title"> Edit Data User </h3>
                        </div>
                    ...
                    <div class="card-block">
                        <section>
                        		...
                        		<div class="col-md-3 col-sm-6 col-12">
                        			<div class="form-group">
                        				<select class="form-control form-control-sm select2" id="jenis">
                        					...
                        					<option value="1" selected="">Agen</option>
                            ...
                            @include('pengaturan.pengaturanpengguna.edit_agen')
                            @include('pengaturan.pengaturanpengguna.edit_pegawai')
