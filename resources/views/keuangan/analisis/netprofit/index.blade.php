...
<head>
    ...
    <title>Mutiara Berlian</title>

    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/app.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('modul_keuangan/bootstrap_4_1_3/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('modul_keuangan/font-awesome_4_7_0/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('modul_keuangan/css/style.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('modul_keuangan/js/vendors/select2/dist/css/select2.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('modul_keuangan/js/vendors/datepicker/dist/datepicker.min.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('modul_keuangan/js/vendors/toast/dist/jquery.toast.min.css') }}">
...
<div id="vue-element">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="box-shadow: 0px 5px 10px #555;">
        <a class="navbar-brand" href="{{ url('/') }}"> CV. Mutiara Berlian</a>
                    ...
                    <div class="card">
                        <div class="card-header bordered p-2">
                            <div class="header-block">
                                <h3 class="title"> Setting Analisis Net Profit Terhadap OCF </h3>
                            </div>
                        </div>
                        <div class="card-block">
                            <form id="data-form" enctype="multipart/form-data"
                                  action="{{ Route('laporan.keuangan.jurnal_umum') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" readonly>
                                <section>
                                    <div class="row keuangan-form"
                                         style="border-bottom: 0px solid #ddd; padding-bottom: 30px;">
                                        <div class="col-md-12" style="border-right: 1px solid #ddd;">
                                            <div class="col-md-12">
                                                <div class="row" style="margin-top: 0px;">
                                                    <div class="col-md-5 label">Jurnal Milik</div>
                                                    <div class="col-md-7">
                                                        <vue-select :name="'lap_cabang'" :id="'lap_cabang'"
                                                                    :options="lap_cabang" :search="false"
                                                                    v-model="single.lap_cabang"></vue-select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row" style="margin-top: 15px;">
                                                    ...
                                                    <div class="col-md-7">
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <vue-datepicker :name="'lap_tanggal_awal'"
                                                                                    :id="'lap_tanggal_awal'"
                                                                                    :class="'form-control'"
                                                                                    :placeholder="'Tgl Awal'"
                                                                                    :title="'Tidak Boleh Kosong'"
                                                                                    :readonly="true"
                                                                                    v-model="single.lap_tanggal_awal"
                                                                                    :style="'font-size: 8pt;'"
                                                                                    @input="tanggalAwalChange"></vue-datepicker>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <vue-datepicker :name="'lap_tanggal_akhir'"
                                                                                    :id="'lap_tanggal_akhir'"
                                                                                    :class="'form-control'"
                                                                                    :placeholder="'Tgl Akhir'"
                                                                                    :title="'Tidak Boleh Kosong'"
                                                                                    :readonly="true"
                                                                                    v-model="single.lap_tanggal_akhir"
                                                                                    :style="'font-size: 8pt;'"></vue-datepicker>
                                                                </td>
                                                            </tr>
                                                            </thead>
                                                        </table>
                        ...
                        <div class="card-footer text-right">
                            <button type="button" class="btn btn-primary btn-sm" @click="terapkan" type="button">
                                Terapkan
                            </button>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 5px;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" @click="terapkan" type="button">Terapkan
                    </button>
                </div>
            </div>
        </div>
    ...
    <iframe style="display: none;" id='pdfIframe' src=''/>
    </iframe>
</div>
