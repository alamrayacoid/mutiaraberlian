...
<html>
	<head>
		...
		<title>Analisa Aset Terhadap ETA</title>
		                    ...
		                    <tbody>
			                    <template v-for="(datas, index) in data.periode">
			                    	<tr>
			                    		...
			                    		<td style="text-align: right; border: 1px solid #ccc;">@{{ humanizePrice(data.ekuitas[index]) }}</td>
			                    		<td style="text-align: right; border: 1px solid #ccc;">@{{ humanizePrice(data.aset[index]) }}</td>
			                    	</tr>
			                    </template>
		                    </tbody>
		                </table>
							...
							<div class="card">
	                            <div class="card-header bordered p-2">
	                                <div class="header-block">
	                                    <h3 class="title"> Analisa Aset Terhadap ETA </h3>
	                                </div>
	                            </div>
	                            <div class="card-block">
	                                <form id="data-form" enctype="multipart/form-data" action="{{ Route('aset_eta.index') }}">
	                                            ...
	                                            <div class="col-md-12" style="border-right: 1px solid #ddd;">
	                                                <div class="col-md-12">
	                                                	<div class="row" style="margin-top: 0px;">
	                                                        <div class="col-md-5 label">Analisa Milik</div>
	                                                        <div class="col-md-7">
	                                                    ...
	                                                    <div class="row" style="margin-top: 15px;">
	                                                        <div class="col-md-5 label">Type Analisa</div>
	                                                        <div class="col-md-7">
				...
				<div class="modal-dialog">
					<div class="modal-content" style="border-radius: 5px;">
						...
						<div class="modal-body" style="font-size: 9.5pt;">
							<form id="data-form-modal" enctype="multipart/form-data" action="{{ Route('aset_eta.index') }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" readonly>
                                <section>
                                    <div class="row keuangan-form" style="border-bottom: 0px solid #ddd; padding-bottom: 30px;">
                                        <div class="col-md-12" style="border-right: 1px solid #ddd;">
            ...
            function initiate(response) {
            	...
            	var chartData = {
					...
					datasets: [{
						...
						borderWidth: 2,
						fill: false,
						data: response.data.aset
					}, {
						type: 'bar',
						label: 'Net Profit',
						backgroundColor: '#FF8800',
						data: response.data.ekuitas
					}]
	            };
			...
			var app = new Vue({
	            ...
	            mounted: function(){
	            	...
	            	if(this.laporanReady == 'true'){
	            		...
	            		axios.get("{{ Route('aset_eta.getData') }}?"+this.url.searchParams)
	                        .then((response) => {
