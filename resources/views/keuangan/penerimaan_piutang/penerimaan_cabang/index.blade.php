<div class="tab-pane animated fadeIn show" id="penerimaancabang">
    <div class="card">
        <div class="card-header bordered p-2">
            <div class="header-block">
                <h3 class="title">Kelola Pembayaran Piutang Cabang </h3><span> (Pelunasan Cabang ke Pusat)</span>
            </div>
            ...
            <section>
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input type="hidden" id="id_cabang_pc" value="">
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-12">
                        <button type="button" class="btn btn-primary" id="btnCari_pc">Cari</button>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover table-striped display nowrap w-100" cellspacing="0" id="table_penerimaancabang">
