...
@section('content')
    <article class="content" id="vue-element">
        <div class="title-block text-primary">
            <h1 class="title"> Master COA Keuangan</h1>
                    ...
                    <div class="card">
                        <div class="card-header bordered p-2">
                            <div class="header-block">
                                <h3 class="title"> Data COA Keuangan </h3>
                            </div>
                            <div class="header-block pull-right">
                                <a class="btn btn-primary" id="e-create" style="color: white" href="{{ Route('keuangan.akun.create') }}">
