...
@section('content')
    <article class="content" id="vue-element">
        ...
        <template v-if="!downloadingResource && !resourceError">
                                        ...
                                        <div class="row keuangan-form">
                                            <div class="col-md-6">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        <div class="col-md-4 label">Saldo Pembukaan</div>
                                                        <div class="col-md-7">
                                                            <vue-inputmask :name="'ak_saldo'" :id="'ak_saldo'" :style="'background: white;'" :minus="false"></vue-inputmask>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row" style="margin-top: -10px;">
                                                        @if(Session::get('isPusat'))
                                                            <div class="col-md-12 label">
                                                                <template v-if="stateForm == 'insert'">
                                                                    <table width="100%" border="0" id="table-form-bottom">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td width="40%" style="padding-bottom: 5px;">
                                                                                    <span class="hintText hint">
                                                                                        &nbsp;Termasuk COA Setara Kas ?
                                                                                    </span>
                                                                                </td>
                                                                                <td width="5%" style="text-align: center;">
                                                                ...
                                                                <template v-if="stateForm == 'update'">
                                                                    <template v-if="single.akunUtama">
                                                                        <span style="font-size: 8pt; font-style: italic;">
                                                                            COA ini termasuk COA utama, sehingga Beberapa informasi terkait dari coa ini tidak bisa diubah.
                                                                        </span>
                                                                    </template>
                                                                </template>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 label">
                                                                <template v-if="stateForm == 'insert'">
                                                                    <span class="hintText hint" @click="addFromUtama">
                                                                        <i class="fa fa-check-square-o"></i>
                                                                        &nbsp; Tambahkan COA dari COA utama. !
                                                                    </span>
                                                                </template>
                                            ...
                                            <div class="col-md-6" style="border: 0px solid #eee; margin-top: -10px">
                                                <div class="row" style="padding-right: 10px;">
                                                    ...
                                                    <div class="col-md-12" style="text-align: center; padding: 10px; font-size: 8pt; border-bottom: 1px solid #eee;">
                                                        Tabel diatas akan menampilkan COA yang sudah tersimpan sesuai dengan kelompok yang dipilih
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
         ...
         @include('keuangan.master.akun._partials._modal')
    </article>
        ...
        var vue = new Vue({
            ...
            computed: {
                serializeAkun: function(e){
                    ...
                    if(kelompok)
                        return $.grep(this.dataAkun, function(e){ return e.ak_kelompok == kelompok.id });
                    else
                        return [];
                }
            },
                ...
                axios.get("{{ Route('keuangan.akun.resource') }}")
                        .then((response) => {
                            ...
                            if(response.data.akunUtama.length){
                                this.akun_utama = response.data.akunUtama;
                            }
            ...
            methods: {
                ...
                saveFromAkunUtama: function(e){
                    ...
                    this.requestMessage = 'Sedang menyimpan data..';
                    this.disabledButton = true;
                    dataForm = $('#form-akun-utama').serialize();

                    axios.post('{{ Route("keuangan.akun.save.utama") }}', dataForm)
                            .then((response) => {
                                console.log(response.data.hierarki);
                                if(response.data.status == 'success'){
                                    $.toast({
                ...
                addFromUtama: function(e){
                    e.preventDefault();
                    e.stopImmediatePropagation();

                    $('#modal_akun_utama').modal('show');
                },
