                            ...
                            <div class="card-block">
                                <section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <select class="form-control select2 form-control-sm" readonly
                                                        name="dataproduk_satuanutama">
                                                    <option value="">--Pilih--</option>
                                                    @foreach ($satuan as $key => $value)
                                                        <option value="{{$value->u_id}}"
                                                                @if ($value->u_id == $data['dataproduk']->i_unit1)
                                                                selected
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input type="number" class="form-control-sm form-control" min="0"
                                                       value="{{(int)$data['dataproduk']->i_unitcompare1}}" readonly
                                                       name="dataproduk_isisatuanutama">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <select class="form-control select2 form-control-sm"
                                                    ...
                                                    @foreach ($satuan as $key => $value)
                                                        <option value="{{$value->u_id}}"
                                                                @if ($value->u_id == $data['dataproduk']->i_unit2)
                                                                selected
                                                            @endif>{{$value->u_name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input type="number" class="form-control-sm form-control" min="0"
                                                       value="{{(int)$data['dataproduk']->i_unitcompare2}}"
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <select class="form-control select2 form-control-sm"
                                                    ...
                                                    @foreach ($satuan as $key => $value)
                                                        <option value="{{$value->u_id}}"
                                                                @if ($value->u_id == $data['dataproduk']->i_unit3)
                                                                selected
                                                            @endif>{{$value->u_name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input type="number" class="form-control-sm form-control" min="0"
                                                       value="{{(int)$data['dataproduk']->i_unitcompare3}}"
