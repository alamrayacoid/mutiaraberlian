...
@include('notifikasiotorisasi.otorisasi.pengeluaranlebih.modal')

<article class="content">

	<div class="title-block text-primary">
	    <h1 class="title"> Otorisasi Pengeluaran lebih dari Nilai tertentu </h1>
	    <p class="title-description">
	    	<i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
	    	 / <span>Notifikasi & Otorisasi</span>
	    	 / <a href="{{route('otorisasi')}}">Otorisasi</a>
	    	 / <span class="text-primary font-weight-bold">Otorisasi Pengeluaran lebih dari Nilai tertentu</span>
	     </p>
	</div>
				...
				<div class="card">
					...
					<div class="card-header bordered p-2">
						<div class="header-block">
							<h3 class="title">Otorisasi Pengeluaran lebih dari Nilai tertentu</h3>
						</div>
