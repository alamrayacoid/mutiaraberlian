                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="form-group">
                                    <select name="employee" id="employeePr" class="form-control form-control-sm select2">
                            ...
                            <div class="col-md-9 col-sm-12">
                                <div class="input-group">
                                    <input type="text" name="time" class="form-control form-control-sm timePr" value="">
                                    <div class="input-group-append">
                                        <button class="btn btn-primary btnTimeNowPr" type="button"><i class="fa fa-clock-o" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                            </div> -->
                        </section>
            						...
            						<tbody>
                                        <tr>
                                            ...
                                            <td class="pad-1 text-center">
                                                ...
                                                <!-- <button class="d-none btn btn-danger btn-sm rounded-circle btnRemoveEmployee" style="color:white;" type="button">
