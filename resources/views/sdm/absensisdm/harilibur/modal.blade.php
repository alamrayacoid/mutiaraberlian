...
<div id="modal_editharilibur" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<!-- Modal content-->
		<div class="modal-content">
			<div class="modal-header bg-gradient-info">
			...
			<div class="modal-body">
				<section class="row">
                    ...
                    <div class="col-8 mb-3">
                        <input type="text" class="form-control form-control-sm text-center" id="edittanggal_libur" readonly>
                    </div>
                    ...
                    <div class="col-8 mb-3">
                        <textarea class="form-control form-control-sm" id="editketerangan_libur"></textarea>
                    </div>
				</section>
			</div>
			<div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="updateHariLibur()">Simpan</button>
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			</div>
		</div>
	</div>
