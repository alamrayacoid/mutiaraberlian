    ...
    <article class="content animated fadeInLeft">
        ...
        <div class="title-block text-primary">
            ...
            <p class="title-description">
                ...
                / <span class="text-primary" style="font-weight: bold;"> Edit Data KPI Divisi</span>
            </p>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header bordered p-2">
                            <div class="header-block">
                                <h3 class="title"> Edit Data KPI Divisi </h3>
                            </div>
                        ...
                        <div class="card-block">
                            <section>
                                <form action="" id="form-edit">
                                    ...
                                    <input type="hidden" name="divisi" value="{{$kpiemp_first->ke_department}}">
                                <div id="section-kpi">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <select class="form-control form-control-sm select2" id="m_divisi" name="ke_department">
                                                            <option value="" disabled="">Pilih Divisi</option>
                                                            @foreach($divisi as $key => $divisi)
                                                            <option value="{{$divisi->m_id}}" @if($divisi->m_id == $kpiemp[0]->ke_department) selected="" @endif>{{$divisi->m_name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
