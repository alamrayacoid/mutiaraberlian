                        ...
                        <div class="card-block">
                            <section>
                                <div id="sectionsuplier" class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control-sm form-control" name="transactionCode" id="transactionCode" style="text-transform: uppercase" value="{{ $data['kpl']->getSalesWeb->sw_transactioncode }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control-sm form-control" name="webUrl" id="webUrl" value="{{ $data['kpl']->getSalesWeb->sw_website }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <textarea class="form-control form-control-sm" name="note" id="note">{{ $data['kpl']->getSalesWeb->sw_note }}</textarea>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function simpan() {
        ...
        axios.post('{{ url('/marketing/agen/kelolapenjualanviawebsite/update-kpw/') }}' +'/'+ $('#salesId').val(), data)
