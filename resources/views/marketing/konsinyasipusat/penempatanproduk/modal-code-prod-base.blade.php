        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table_listcodeprod" id="table_listcodeprods" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr class="rowBtnAdd">
                                <td><input type="text" class="form-control form-control-sm" style="text-transform: uppercase" name="prodCode[]"></td>
                                <td><input type="text" class="form-control form-control-sm digits qtyProdCode" name="qtyProdCode[]" value="0"></td>
                                <td><button class="btn btn-success btnAddProdCode btn-sm rounded-circle" title="Tambah Kode Produksi" type="button"><i class="fa fa-plus" aria-hidden="true"></button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
