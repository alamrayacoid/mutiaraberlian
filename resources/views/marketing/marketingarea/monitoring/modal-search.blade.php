<!-- Modal -->
<div id="modalSearchAgentMPA" class="modal fade animated fadeIn" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="row mb-3">
        ...
        <div class="table-responsive table-modal d-none">
          <table class="table table-striped table-hover display nowrap data-table" cellspacing="0" id="table_search_mpa" width="100%">
