      ...
      <section>
        <div class="row">
          ...
          <div class="col-10 mb-3">
            <input type="text" class="form-control form-control-sm datepicker" value="07-09-2019" readonly="">
          </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover display nowrap" cellspacing="0" id="modal-order" width="100%">
