...
@section('content')
    ...
    <article class="content animated fadeInLeft">
        ...
        <div class="title-block text-primary">
            <h1 class="title"> Tambah Order Produk ke Pusat </h1>
            <p class="title-description">
                <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
                / <span>Aktivitas Marketing</span>
                / <a href="{{route('order.index')}}"><span>Manajemen Marketing Area</span></a>
                / <span class="text-primary" style="font-weight: bold;"> Tambah Order Produk ke Pusat</span>
            </p>
        </div>
