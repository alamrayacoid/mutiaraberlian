<!-- Modal -->
<div id="modalEditPembayaran" class="modal fade animated fadeIn" role="dialog">
    <div class="modal-dialog modal-lg">

        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header bg-gradient-info">
                <h4 class="modal-title">Edit Pembayaran Piutang</h4>
            ...
            <div class="modal-body">
                <section>
                    <div class="row">
                        ...
                        <div class="col-4 mb-3">
                            <input type="text" class="form-control form-control-sm datepicker" id="date_tempo" readonly>
                        </div>
                ...
                <section>
                    <div class="row">
                        ...
                        <div class="form-group col-md-2 col-sm-12" style="padding-top: 10px;">
                            <button type="button" class="btn btn-primary" id="btnUpdate" style="width: 100%; margin-top: 17px !important;"><i class="fa fa-money"></i> Update</button>
                        </div>
                    </div>
                </section>
