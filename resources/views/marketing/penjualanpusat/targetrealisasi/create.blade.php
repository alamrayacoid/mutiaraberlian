    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.btn-tambah').on('click', function () {
                ...
                $('#table_target')
                    .append(
                        ...
                        '</td>' +
                        '<td>' +
                        '<input type="number" class="form-control form-control-sm qty" min="0" name="t_qty[]">' +
                        '</td>' +
                        '<td class="text-center"><button class="btn btn-danger btn-hapus btn-sm" type="button"><i class="fa fa-close"></i></button></td>' +
                        '</tr>'
                    );
            ...
            $(document).on('click', '.btn-submit', function (evt) {
                ...
                if (periode == '' || periode == null || cabang == null || cabang == '') {
                    messageWarning('Perhatian!', 'Lengkapi form terlebih dahulu...!');
                    return false;
                }
                evt.preventDefault();
                $.ajax({
        ...
        function validasiBarang() {
            ...
            console.log(find_duplicate_in_array(item));
        }
    </script>
@endsection
