...
@section('content')
    <article class="content animated fadeInLeft">
        ...
        <div class="title-block text-primary">
            <h1 class="title"> Tambah Data Order Produk ke Cabang/Pusat </h1>
            <p class="title-description">
                <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
                / <span>Aktivitas Marketing</span>
                / <a href="{{route('penjualanpusat.index')}}"><span>Manajemen Penjualan Pusat </span></a>
                / <span class="text-primary" style="font-weight: bold;"> Tambah Data Order Produk ke Cabang/Pusat </span>
            </p>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header bordered p-2">
                            <div class="header-block">
                                <h3 class="title"> Tambah Data Order Produk ke Cabang/Pusat </h3>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input name="order" class="form-control form-control-sm" value="PUSAT" id="order_pusat" readonly>
                                                <input type="hidden" name="c_cabang" value="{{ $pusat->c_id }}">
                                            </div>
                                        </div>
                                        @include('marketing.penjualanpusat.terimaorder.ordercabang')
                                    </div>
                                </section>
                            </div>
...
@section('extra_script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.btn-submit', function (evt) {
                ...
                if (checkFormCabang() == "cek form") {
                    messageWarning('Peringatan', 'Lengkapi data order produk ke Cabang/Pusat');
                }
                else {
                    $.confirm({
                        animation: 'RotateY',
        ...
        function getProvCabang() {
            ...
            axios.get('{{ route('orderagenpusat.getprovinsi') }}')
                .then(function (resp) {
                    ...
                    var option = '<option value="" selected disabled>Pilih Provinsi</option>';
                    var prov = resp.data;
                ...
                if ($("#c_prov").val() != "") {
                    ...
                    axios.get(baseUrl+'/marketing/agen/orderproduk/get-kota/'+$("#c_prov").val())
                        .then(function (resp) {
                            ...
                            var option = '<option value="" selected disabled>Pilih Kota</option>';
                            var kota = resp.data;
            ...
            $("#c_apb").on("change", function (evt) {
                ...
                axios.get(baseUrl+'/marketing/agen/orderproduk/get-cabang', {params: {
                    ...
                    .then(function (resp) {
                        ...
                        var option = '<option value="" selected disabled>Pilih Cabang</option>';
        ...
        //                     var option = '<option value="" selected disabled>Pilih Agen Penjual</option>';
