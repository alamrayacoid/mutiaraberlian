                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <input name="order" class="form-control form-control-sm" value="" id="order_pusat" readonly>
                                                {{--<select name="select_order" id="select-orderpusat" class="form-control form-control-sm select2">
