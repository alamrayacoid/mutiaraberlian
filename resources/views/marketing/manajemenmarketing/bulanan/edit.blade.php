...
@section('content')
    ...
    <article class="content animated fadeInLeft">
        ...
        <div class="title-block text-primary">
            <h1 class="title"> Edit Data Promosi Bulanan </h1>
            <p class="title-description">
                <i class="fa fa-home"></i>&nbsp;<a href="{{url('/home')}}">Home</a>
                / <span>Marketing</span>
                / <a href="{{route('mngmarketing.index')}}"><span>Manajemen Marketing</span></a>
                / <span class="text-primary font-weight-bold">Edit Data Promosi Bulanan</span>
            </p>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header bordered p-2">
                            <div class="header-block">
                                <h3 class="title">Edit Data Promosi Bulanan</h3>
                            </div>
        ...
        $(document).ready(function () {
            $(document).on('click', '.btn-submit', function () {
                ...
                if (valid == 1){
                    ...
                    axios.post('{{ route("monthpromotion.update") }}', {
                        "judul": judul,
                        "bulan": bulan,
                        "output": output,
                        "outcome": outcome,
