...
//    ==========End Master Outlet======
    ...
    Route::get('/sdm/kinerjasdm/kpi-divisi/get-kpi-divisi_d', 'SDM\MasterKPIController@get_kpi_divisi_d')->name('kpidivisi.get_kpi_divisi_d');
    Route::get('/sdm/kinerjasdm/kpi-divisi/get-kpi-divisi', 'SDM\MasterKPIController@get_kpi_divisi')->name('kpidivisi.get_kpi_divisi');
    Route::post('/sdm/kinerjasdm/kpi-divisi/save-kpi-divisi', 'SDM\MasterKPIController@save_kpi_divisi')->name('kpidivisi.save_kpi_divisi');
    Route::get('/sdm/kinerjasdm/kpi-divisi/get-detail-kpi-divisi', 'SDM\MasterKPIController@get_detail_kpi_divisi')->name('kpidivisi.get_detail_kpi_divisi');
    ...
    Route::get('/sdm/penggajian/salary/print-gaji-pegawai', 'SDM\SalaryController@printGajiPegawai')->name('salary.printGajiPegawai');
    ...
    Route::post('/marketing/penjualanpusat/targetrealisasi/updateTarget', 'Aktivitasmarketing\Penjualanpusat\PenjualanPusatController@updateTarget')->name('targetReal.update');
    // Penerimaan Piutang ---------------------------
    ...
    Route::get('/marketing/marketingarea/penerimaanpiutang/get-detail-payment', 'Aktivitasmarketing\Marketingarea\MMAPenerimaanPiutangController@getDetailPayment')->name('mmapenerimaanpiutang.getDetailPayment');
    Route::post('/marketing/marketingarea/penerimaanpiutang/update-payment', 'Aktivitasmarketing\Marketingarea\MMAPenerimaanPiutangController@updatePayment')->name('mmapenerimaanpiutang.updatePayment');
    ...
    Route::get('/checkdate', 'getnotifikasiController@checkDatePayment');
