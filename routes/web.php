...
//    ==========End Master Outlet======
    ...
    Route::get('/marketing/marketingarea/index', 'Aktivitasmarketing\Marketingarea\MarketingAreaController@index')->name('marketingarea.index');
        ...
        Route::get('/marketing/marketingarea/orderproduk/delete-order', 'Aktivitasmarketing\Marketingarea\MarketingAreaController@deleteOrder')->name('orderProduk.delete');
        // End Order Ke Cabang ==================
